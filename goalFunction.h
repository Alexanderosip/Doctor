...
extern void generate(vector < vector <float> > Qij, vector < vector <float> > Rik, vector <float> Vi, vector <int> Oi); // функция генерирует данные
extern void letsCheck( vector <vector <float> > Rik, vector <vector <float> > Qij, vector <float> Vi, vector <int> Oi);
